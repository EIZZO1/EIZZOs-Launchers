...
public class LauncherTabCompleter implements TabCompleter {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String[] args) {
        ...
        if (args.length == 1) {
            ...
            List<String> props = Arrays.asList("vertical", "horizontal", "boat", "particle1", "particle2", "trail_particle1", "trail_particle2", "sound");
            ...
            } else if (prop.equals("particle1") || prop.equals("particle2") || prop.equals("trail_particle1") || prop.equals("trail_particle2")) {
